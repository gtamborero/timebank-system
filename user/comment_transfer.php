	...
	<td><?php _e('Comment', 'timebank'); ?>: </td><td><textarea id="comment2" name="comment2" maxlength="150" rows=3 style="resize: none; width:95%;" /></textarea> </td><tr>
	<td><?php _e('Rating', 'timebank'); ?>: </td><td>
	...
	<td colspan="2" style="background-color:#FFFFFF;"><input id="COMMENT_TRANSFER" type="submit" name="ACCEPT" value="<?php _e('SEND', 'timebank'); ?>" style="float:right;" /></td>
	</table>
